...
export default function Home() {
  ...
  return (
    <>
    <Head>
        <title>easyREADME - Create Beautiful Readmes</title>
        <meta name="description" content="Generate customizable readme files with ease!" />
      ...
      <div className="bg-gray-800">
            ...
            <h2 className="text-center text-gray-400 text-sm font-semibold tracking-wide">
              ...
              <a
                ...
                href="https://in.linkedin.com/in/sayantan-biswas-352a8a27b"
                target="__blank"
              >
                Sayantan Biswas
              </a>
